...
\CMT{Is there a way to make these take up less space}
\begin{figure*}[h]
  \centering
  \begin{minipage}{0.45\linewidth}
      \includegraphics[width=\linewidth]{omp_weak2.out}
      \caption{\TODO{HI}: omp weak 2\&
        Ewing, Inc. [Public domain], via Wikimedia
        Commons. (\url{https://goo.gl/VLCRBB}).}
...
\CMT{Maybe these can be also done with the same dual layout}
\begin{figure}[h]
  \centering
