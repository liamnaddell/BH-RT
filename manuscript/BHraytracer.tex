...
such as te ones remarkably done for the black hole reciding at the center of the galaxy M87 \cite{M87_EHT_i},
...
\begin{figure}[h]
  ...
  \caption{Nice diagram -- \TODO{now, we need a description of it}}
  \label{fig:one}
\end{figure}
