...
In order to model a simple black hole, we can use the Schwarzschild metric.
...
\begin{equation}
	u'' - u = 3 M u^2
\end{equation}
relates the trajectory of a light ray to the mass of a black hole, from the Schwarzschild metric;
...
Out implementation is available in the following GitHub repository
	\TODO{add repo}
