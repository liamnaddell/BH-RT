...
In this type of problems, it is possible to consider different \textit{metrics} to analyze the scaling behaviou of a given implementation.
...
techniques.
As a rich computational project, it combines elements from mutliple disciplines, specifically
