...
iii) the ease of implementation \CMT{Liam: I'm not sure what is meant by this? I changed it to be more clear to me?} in a fairly efficient and high-performing
...
GitHub repository: (\url{https://github.com/liamnaddell/BHRaytracer})
\TODO{Should this be a \\href ?  I think it would be visually more appealing}
