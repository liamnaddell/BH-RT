...
%Liam: This sentence ruins the flow.
...
\CMT{M:Are Figs.~\ref{fig:omp_weak} and \ref{fig:mpi_strong_multinode} the scaling analysis for the hybrid code? It looks like that, so we also need to specify this then... L: I specify in the paragraph below the figure. If I specify in the figure it ruins the alignment}
