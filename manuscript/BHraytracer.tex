 ...
 \caption{Weak scaling analysis where MPI process/OMP thread count and image width are increased in tandem.}
  ...
  \begin{minipage}{0.45\linewidth}
	  ...
	  \caption{Strong scaling analysis as MPI process count is increased.
  		It is worth noticing, in particular when comparing Figs.~\ref{fig:mpi_strong} and \ref{fig:omp_strong},
    		that although the runtimes are within a few seconds, the differences may be appreciated by comparing relative speedups.
   		}
